python3 create_serial_analysis_script_extended_eval.py
chmod +x run_serial_analysis_extended_eval.sh
./run_serial_analysis_extended_eval.sh
...
mv cost.png results/
./archive.sh extended_eval
python3 single_plot.py --path extended_eval/analysis_results/ --name results_final --reps 4
python3 budget_usage_plot.py --path extended_eval/analysis_results/ --name budget_usage_final --reps 4
