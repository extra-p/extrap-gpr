...
def main():
    ...
    if args.name:
        ...
        plot_name = "paper_plot_points_gpr_only.pdf"
    ...
    labels_points = ['Full matrix', 'CPF strategy', 'GPR strategy', 'Minimum points required $\\bar{p}_{min}$']
