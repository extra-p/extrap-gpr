...
def main():
    ...
    if args.name:
        ...
        plot_name = "paper_plot_buckets_gpr_only.pdf"
    ...
    fig.legend(handles, labels, loc='upper center', ncol=4, bbox_to_anchor=(0.5, 1.175), frameon=False, fontsize=8, columnspacing=0.8)
