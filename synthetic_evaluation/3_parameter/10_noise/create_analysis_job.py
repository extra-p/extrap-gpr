...
python ../../../synthetic_evaluation.py --nr-parameters 3 --nr-functions 1000 --nr-repetitions 5 --noise 10 --mode budget --budget """+str(counter)+""" --normalization True --plot True
