...
mv cost.png results/
./archive.sh filtered
python3 single_plot.py --path filtered/analysis_results/ --name results_filtered --reps 5
python3 budget_usage_plot.py --path filtered/analysis_results/ --name budget_usage_filtered --reps 5
