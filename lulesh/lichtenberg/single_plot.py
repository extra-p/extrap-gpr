...
def main():
    ...
    fig.suptitle("Evaluation results LULESH ("+str(nr_func_modeled)+" kernels > 1% runtime)")
    ...
    ax1.set_xticks(np.arange(10, 105, 10))
    ...
    ax2.set_xticks(np.arange(10, 105, 10))
    ...
    ax3.set_xticks(np.arange(10, 105, 10))
    ...
    ax4.set_xticks(np.arange(10, 105, 10))
    ...
    ax6.set_yticks(np.arange(0, ((26-1)*reps)+10, 15))
    ax6.set_xlim(9,105)
