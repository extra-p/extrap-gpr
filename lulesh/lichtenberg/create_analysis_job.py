...
python .\case_study.py --cube E:\lulesh\ --processes 0 --parameters "p","s" --eval_point "1000","35" --filter 0 --budget """++str(counter)""" --normalization True
