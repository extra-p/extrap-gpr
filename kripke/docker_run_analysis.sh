...
mv cost.png results/
./archive.sh all
python3 single_plot.py --path all/analysis_results/ --name results_all --reps 5
python3 budget_usage_plot.py --path all/analysis_results/ --name budget_usage_all --reps 5
